 ...
 */
public class GCalendarGRecurrenceTest {
    ...
    public void delEvents() throws Exception {
        GEvent gEvent = new GEvent("Event from GCalendarApp Recurrence", start, new Date(start.getTime() + 10000));
        addEvents();
        List<GEvent> readEvents = gCalendar.getEvents(new GEventChecker()
                .setTitle(gEvent.getTitle())
                .setStartAfterDate(gEvent.getStart())
                .setFinishBeforeDate(gEvent.getFinish()), true);
    ...
    public void addEvents() throws Exception {
        GEvent gEvent = new GEvent("Event from GCalendarApp Recurrence", start, new Date(start.getTime() + 10000));
        gEvent.setReccurence(new GRecurrence()
                .setStartDate(start)
                .setFrequency(GRecurrence.WEEKLY)
                .setByDay(new int[]{GRecurrence.MONDAY, GRecurrence.WEDNESDAY})
                .setFrequencyCount(4));
